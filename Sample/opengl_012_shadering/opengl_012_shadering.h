...
#ifndef _OPENGL_012_SHADERING_H_
#define _OPENGL_012_SHADERING_H_

#include "OpenGLWindow.h"
using namespace LostPeterOpenGL; 

class OpenGL_012_Shadering : public OpenGLWindow
{
public:
    OpenGL_012_Shadering(int width, int height, String name);

public:
	/////////////////////////// ModelMesh ///////////////////////////
    struct ModelMesh
    {
        OpenGL_012_Shadering* pWindow;
        String nameMesh;
        String pathMesh;
        FMeshType typeMesh;
        ...
        ModelMesh(OpenGL_012_Shadering* _pWindow, 
	...
	struct ModelObject
	{
		ModelObject(OpenGL_012_Shadering* _pWindow)
			//Common
			: pWindow(_pWindow)
