...
class OpenGL_009_Instancing : public OpenGLWindow
{
public:
    OpenGL_009_Instancing(int width, int height, String name);

public:
	struct ModelObject
	{
		ModelObject(OpenGL_009_Instancing* _pWindow)
			//Common
			: pWindow(_pWindow)
