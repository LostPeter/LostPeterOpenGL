...
{
    "Assets/Shader/Common/standard_mesh_opaque_tex2d_lit.vert.spv", "Assets/Shader/Common/standard_mesh_opaque_tex2d_lit.frag.spv", //standard_mesh_opaque_tex2d_lit
    "Assets/Shader/Common/standard_mesh_transparent_lit.vert.spv", "Assets/Shader/Common/standard_mesh_transparent_lit.frag.spv", //standard_mesh_transparent_lit
};
...
{
    "Assets/Shader/Common/standard_mesh_opaque_tex2d_lit", //plane 
    "Assets/Shader/Common/standard_mesh_transparent_lit", //viking_room
    "Assets/Shader/Common/standard_mesh_opaque_tex2d_lit", //bunny 
};
...
OpenGL_010_Lighting::OpenGL_010_Lighting(int width, int height, String name)
...
void OpenGL_010_Lighting::createCamera()
{
...
void OpenGL_010_Lighting::loadModel_Custom()
{
    for (int i = 0; i < g_CountLen; i++)
    {
        ...
        {
            String msg = "*********************** OpenGL_010_Lighting::loadModel_Custom: Failed to load model: " + pModelObject->pathModel;
        ...
        {   
            String msg = "*********************** OpenGL_010_Lighting::loadModel_Custom: Failed to load texture: " + pModelObject->pathTexture;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
...
bool OpenGL_010_Lighting::loadModel_VertexIndex(ModelObject* pModelObject, bool isFlipY, bool isTransformLocal, const FMatrix4& matTransformLocal)
{
    //1> Load 
    FMeshData meshData;
    ...
    {
        F_LogError("*********************** OpenGL_010_Lighting::loadModel_VertexIndex load model failed: [%s] !", pModelObject->pathModel.c_str());
        return false; 
    }
    ...
    F_LogInfo("OpenGL_010_Lighting::loadModel_VertexIndex: load model [%s] success, Vertex count: [%d], Index count: [%d] !", 
		...
		pModelObject->poIndexBuffer_Data != nullptr)
	{
		...
		{
			F_LogError("*********************** OpenGL_010_Lighting::loadModel_VertexIndex: create buffer vertex index failed: [%s] !", pModelObject->nameModel.c_str());
			return false;
		}
	}
	else
	{
		...
		{
			F_LogError("*********************** OpenGL_010_Lighting::loadModel_VertexIndex: create buffer vertex failed: [%s] !", pModelObject->nameModel.c_str());
			return false;
		}
	}
...
bool OpenGL_010_Lighting::loadModel_Texture(ModelObject* pModelObject)
{
    if (!pModelObject->pathTexture.empty())
    {
		...
		{
			F_LogError("*********************** OpenGL_010_Lighting::loadModel_Texture: Failed to create texture, path: [%s] !", pModelObject->pathTexture.c_str());
			F_DELETE(this->poTexture)
			return false;
		}
        F_LogInfo("OpenGL_010_Lighting::loadModel_Texture: Load texture [%s] success !", pModelObject->pathTexture.c_str());
    }

    return true;
}

void OpenGL_010_Lighting::createCustomCB()
{
    rebuildInstanceCBs(true);
}
void OpenGL_010_Lighting::rebuildInstanceCBs(bool isCreateBuffer)
{
    ...
    for (size_t i = 0; i < count; i++)
    {
		...
		if (isCreateBuffer)
		{
			...
			{
				String msg = "*********************** OpenGL_010_Lighting::rebuildInstanceCBs: create buffer uniform: [" + nameBuffer + "] failed !";
...
void OpenGL_010_Lighting::createCustomBeforePipeline()
{
    //1> Shader
    createShaderModules();
}  
void OpenGL_010_Lighting::createGraphicsPipeline_Custom()
{
    String namePathBase;
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        {
            String msg = "*********************** OpenGL_010_Lighting::createGraphicsPipeline_Custom: Failed to create pipeline stencil !";
            F_LogError(msg.c_str());
            throw std::runtime_error(msg.c_str());
        }
    }
...
void OpenGL_010_Lighting::destroyShaderModules()
{
...
void OpenGL_010_Lighting::createShaderModules()
{
    ...
    for (int i = 0; i < g_ShaderCount; i++)
    {
        ...
        {
            String msg = "*********************** OpenGL_010_Lighting::createShaderModules: Failed to create shader vertex: " + pathVert;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
        this->m_aGLShaderModules.push_back(pShaderVertex);
        this->m_mapGLShaderModules[pathVert] = pShaderVertex;
        F_LogInfo("OpenGL_010_Lighting::createShaderModules: create shader [%s] success !", pathVert.c_str());
        ...
        {
            String msg = "*********************** OpenGL_010_Lighting::createShaderModules: Failed to create shader fragment: " + pathFrag;
            F_LogError(msg.c_str());
            throw std::runtime_error(msg);
        }
        this->m_aGLShaderModules.push_back(pShaderFragment);
        this->m_mapGLShaderModules[pathFrag] = pShaderFragment;
        F_LogInfo("OpenGL_010_Lighting::createShaderModules: create shader [%s] success !", pathFrag.c_str());
    }
}
GLShader* OpenGL_010_Lighting::findShaderModule(const String& pathShaderModule)
{
...
void OpenGL_010_Lighting::createDescriptorSets_Custom()
{
    size_t count = this->m_aModelObjects.size();
    for (size_t i = 0; i < count; i++)
    {
...
void OpenGL_010_Lighting::updateCBs_Custom()
{
...
bool OpenGL_010_Lighting::beginRenderImgui()
{
    ImGui_ImplOpenGL3_NewFrame();
    ImGui_ImplGlfw_NewFrame();
    ImGui::NewFrame();
    static bool windowOpened = true;
    ImGui::Begin("OpenGL_010_Lighting", &windowOpened, 0);
    {
        //0> Common
        commonConfig();
...
void OpenGL_010_Lighting::modelConfig()
{
...
void OpenGL_010_Lighting::endRenderImgui()
{
    OpenGLWindow::endRenderImgui();

}

void OpenGL_010_Lighting::drawMeshDefault_Custom()
{   
    ...
    for (size_t i = 0; i < count; i++)
    {
		...
		{	
			F_Assert(false && "OpenGL_010_Lighting::drawMeshDefault_Custom")
		}
