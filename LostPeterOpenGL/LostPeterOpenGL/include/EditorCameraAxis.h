...
namespace LostPeterOpenGL
{
	...
	public:
		...
		GLBufferUniform* poBufferUniform_PassCB;
		...
		GLFrameBuffer* poFrameBufferCameraAxis;
		GLRenderPass* poRenderPassCameraAxis;
	...
	public:
		...
		GLBufferUniform* poBufferUniform_CopyBlitObjectCB;
