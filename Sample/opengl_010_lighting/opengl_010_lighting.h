...
class OpenGL_010_Lighting : public OpenGLWindow
{
public:
    OpenGL_010_Lighting(int width, int height, String name);

public:
	struct ModelObject
	{
		ModelObject(OpenGL_010_Lighting* _pWindow)
			//Common
			: pWindow(_pWindow)
