    ...
    void EditorCameraAxis::initConfigs()
    {
        ...
        //2> Shader
        {
            //CameraAxis
            {
                ...
                siVert.pathShader = Base::GetWindowPtr()->getShaderPathRelative("editor_camera_axis.vert.spv", ShaderSort_Common);
                ...
                siFrag.pathShader = Base::GetWindowPtr()->getShaderPathRelative("editor_camera_axis.frag.spv", ShaderSort_Common);
            ...
            //Quad Blit
            {
                ...
                siVert.nameShaderType = "vert";
                siVert.pathShader = Base::GetWindowPtr()->getShaderPathRelative("standard_copy_blit_to_frame.vert.spv", ShaderSort_Common);
                this->aShaderModuleInfos.push_back(siVert);
                //Frag
                ShaderModuleInfo siFrag;
                siFrag.nameShader = s_strNameShader_QuadBlit_Frag;
                siFrag.nameShaderType = "frag";
                siFrag.pathShader = Base::GetWindowPtr()->getShaderPathRelative("standard_copy_blit_to_frame.frag.spv", ShaderSort_Common);
                this->aShaderModuleInfos.push_back(siFrag);
            }
        }
        //3> BufferUniform
    ...
    void EditorCameraAxis::initPipelineGraphics()
    {
        ...
        //GLStatePipelineGraphics
        {
            //CameraAxis
            {
				...
				GLShader* pShaderVertex = GetShader(s_strNameShader_CameraAxis_Vert); 
                ...
                GLTexture* pTexture = pWindow->createTexture(nameTextureColor,
															 aPathTexture,
														     nullptr,
														   	 4,
															 w,
            ...
            //Quad Blit
            {
				...
				GLShader* pShaderVertex = GetShader(s_strNameShader_QuadBlit_Vert); 
				F_Assert("EditorCameraAxis::initPipelineGraphics: Shader Vetex" && pShaderVertex)
