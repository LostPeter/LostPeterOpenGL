...
@REM #2) Build LostPeterOpenGL
if "%debug%" == "debug" (
    set name_project="LostPeterOpenGL_d"
    set name_lib="LostPeterOpenGL_d.lib"
    set name_dll="LostPeterOpenGL_d.dll"
) else (
    set name_project="LostPeterOpenGL"
    set name_lib="LostPeterOpenGL.lib"
    set name_dll="LostPeterOpenGL.dll"
)
...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../LostPeterOpenGL/"
