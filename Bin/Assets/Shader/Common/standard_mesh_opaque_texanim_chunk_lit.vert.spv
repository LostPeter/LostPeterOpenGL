...
void main()
{
	...
	fragTexCoord = vec2((inTexCoord.x + mat.aTexLayers[0].texChunkIndexX) / mat.aTexLayers[0].texChunkMaxX, (inTexCoord.y + mat.aTexLayers[0].texChunkIndexY) / mat.aTexLayers[0].texChunkMaxY);
}